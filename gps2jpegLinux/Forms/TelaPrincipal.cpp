...
TelaPrincipal::TelaPrincipal() {
    ...
    //   me->addAction(widget.actionSair);
    //   me->addAction(widget.actionRemoverImagem);
...
void TelaPrincipal::configuraTelaPrincipal() {
    ...
    widget.tableWidgetJpeg->setColumnWidth(6, 100);
    ...
    manipulaExifFotos = new ManipulaExifFotos(gerenciaTrackLogs);
...
void TelaPrincipal::openMenuTableWidgetJpeg() {
    ...
    std::cout << "sadsdadsaasd" << std::endl;
}